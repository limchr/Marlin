 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 813 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 16, 23, -1.5 }
...
#define Y_MIN_POS -32
#define Z_MIN_POS 0
#define X_MAX_POS 310 // was set to X_BED_SIZE
#define Y_MAX_POS 305 // was set to Y_BED_SIZE
